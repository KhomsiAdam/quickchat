...
const ChatInput: FC<ChatInputProps> = ({ chatPartner, chatId }) => {
  ...
  return (
    <div className='px-4 pt-4 mb-2 border-t border-gray-200 sm:mb-0'>
      <div className='relative flex-1 overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-secondary-600 dark:focus-within:ring-primary-600'>
        <TextareaAutosize
          ref={textareaRef}
          onKeyDown={(e) => {
